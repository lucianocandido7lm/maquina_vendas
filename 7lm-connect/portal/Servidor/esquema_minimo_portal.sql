...
CREATE TABLE IF NOT EXISTS connect_comercial.imovel (
  ...
  valor_desconto_minimo numeric(14,2) NOT NULL DEFAULT 0,
  valor_desconto_maximo numeric(14,2) NOT NULL DEFAULT 50000,
  ...
  CONSTRAINT ck_imovel_valor_desconto_minimo CHECK (valor_desconto_minimo >= 0),
  CONSTRAINT ck_imovel_valor_desconto_maximo CHECK (valor_desconto_maximo >= 0),
  CONSTRAINT ck_imovel_valor_desconto_faixa CHECK (valor_desconto_maximo >= valor_desconto_minimo),
...
VALUES
  ('administracao.view', 'Permite visualizar a área administrativa do portal.'),
  ('administracao.manage', 'Permite gerenciar usuários, perfis e permissões no portal.'),
  ...
  ('rh.acesso', 'Permite visualizar a área de Gente e Gestão.'),
  ('ACESSO_TOTAL', 'Permite acesso administrativo amplo.'),
  ('GERENCIAR_ACESSO', 'Permite gerenciar os acessos do portal.'),
  ('imoveis.view', 'Permite visualizar a listagem de imóveis.'),
  ('imoveis.create', 'Permite cadastrar novos imóveis.'),
  ('imoveis.edit', 'Permite editar dados de imóveis.'),
  ('imoveis.delete', 'Permite excluir imóveis.'),
  ('imoveis.media.manage', 'Permite enviar e remover fotos e videos de imóveis.'),
...
VALUES
  ('Administrador do Portal', 'Perfil inicial com gestão completa do 7LM.'),
  ('Gerente Comercial', 'Acesso gerencial ao módulo comercial.'),
  ('Gestor Comercial', 'Acesso de gestão ao módulo comercial.'),
  ('Acesso Básico', 'Perfil base para usuários autenticados do portal.')
