const BASE_INDICATORS = {
  ...
  propostas: { id: 'propostas', title: 'Propostas', description: 'Propostas com resposta de analise.' },
  cancelamentos: { id: 'cancelamentos', title: 'Cancelamentos', description: 'Reservas canceladas no periodo.' },
  vendas: { id: 'vendas', title: 'Vendas Finalizadas', description: 'Reservas com data_venda preenchida.' },
