  ...
  [9933],
  {
    29933: (t, e, i) => {
      ...
      var o = class {
        ...
        p = class {
          ...
          constructor({
            ...
            ((window.lenisVersion = "1.3.17"),
              ...
              "number" == typeof h && "function" != typeof p
                ? (p = c)
                : "function" == typeof p && "number" != typeof h && (h = 1),
              (this.options = {
                wrapper: t,
                content: e,
                eventsTarget: i,
              ...
              (this.virtualScroll = new a(i, { touchMultiplier: f, wheelMultiplier: w })),
                ...
                if (
                  ("string" == typeof t
                    ? (i = document.querySelector(t)) ||
                      ("#top" === t ? (t = 0) : console.warn("Lenis: Target not found", t))
          ...
          checkNestedScroll(t, { deltaX: e, deltaY: i }) {
            ...
            if (
              ...
              ("horizontal" === g
                ...
                : "vertical" === g
                  ? (p = "y")
                  : (0 !== e && s && r && (p = "x"), 0 !== i && o && n && (p = "y")),
              !p)
            )
              return !1;
            if ("x" === p) ((u = t.scrollLeft), (d = l - a), (m = e), (v = s), (f = r));
            else {
              if ("y" !== p) return !1;
        ...
        f = (0, u.forwardRef)((t, e) => {
          let { children: i, root: s = !1, options: o = {}, autoRaf: r = !0, ...n } = t,
            l = (0, u.useRef)(null),
            h = (0, u.useRef)(null),
            [a, c] = (0, u.useState)(void 0);
          ((0, u.useImperativeHandle)(
            e,
            () => ({ wrapper: l.current, content: h.current, lenis: a }),
            [a]
          ),
            (0, u.useEffect)(() => {
              let t = new p({
                ...o,
                ...(l.current && h.current && { wrapper: l.current, content: h.current }),
                autoRaf: o?.autoRaf ?? r,
              });
              return (
                c(t),
            ...
            }, [s, JSON.stringify({ ...o, wrapper: null, content: null })]));
          let f = (0, u.useRef)([]),
            w = (0, u.useCallback)((t, e) => {
              (f.current.push({ callback: t, priority: e }),
          ...
          return ((0, u.useEffect)(() => {
            if (s && a)
              return (v.set({ lenis: a, addCallback: w, removeCallback: S }), () => v.set(null));
          }, [s, a, w, S]),
          (0, u.useEffect)(() => {
            if (!a) return;
            let t = (t) => {
          ...
          i)
            ? (0, d.jsx)(m.Provider, {
                value: { lenis: a, addCallback: w, removeCallback: S },
                children:
                  s && "asChild" !== s
                    ? i
                    : (0, d.jsx)("div", {
      ...
      function S(t) {
        let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
          ...
          { lenis: r, addCallback: n, removeCallback: l } = s ?? o ?? w;
        return (
          (0, u.useEffect)(() => {
            if (t && n && l && r)
              return (
