      ...
      function y(e) {
        ...
        let B = L ? n && "object" == typeof n && n.ref : R,
          z = u.default.useCallback(
            (e) => (
              null !== w && (P.current = (0, f.mountLinkInstance)(e, D, w, F, M, b)),
              () => {
                (P.current &&
                  ((0, f.unmountLinkForCurrentNavigation)(P.current), (P.current = null)),
        ...
        return (
          ...
          (a = L ? u.default.cloneElement(n, Q) : (0, o.jsx)("a", { ...k, ...Q, children: r })),
