    ...
    async with pool.acquire() as conexao:
        ...
        pessoas_ativas = await conexao.fetch(
            ...
            select
                ...
                ur.metodo_http as ultimo_metodo,
                ur.codigo_resposta_http as ultimo_status_http,
                ur.duracao_milisegundos as ultima_duracao_ms,
        ...
        atividades_recentes = await conexao.fetch(
            ...
            (
                ...
                from sevenlm_connect.auditoria_evento a
                left join sevenlm_connect.usuario u
